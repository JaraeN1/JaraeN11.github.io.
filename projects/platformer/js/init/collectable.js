(function (window) {
    ...
    collectable.init = function (game) {
        ...
        // example: 
        collectable.create(type.steve, 600, 500, 6, 0.7);
        collectable.create(type.kennedi, 570, 210, 7, 0.6);
        collectable.create(type.max, 100, 210, 3, 1);
        collectable.create(type.grace, 300, 220, 7, 0.4);
